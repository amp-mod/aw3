// Based off https://github.com/TurboWarp/extensions/blob/3b5c03d/extensions/TheShovel/profanity.js

const decode = (str: string) =>
	atob(
		str
			.split('')
			.map((i: string) => String.fromCharCode(i.charCodeAt(0) - 1))
			.join(''),
	)
