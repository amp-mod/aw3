...
<svelte:head>
	<title>Get Desktop App - AmpMod</title>
</svelte:head>
...
>
	<h1 class="text-5xl font-extrabold tracking-tight text-accent">Download AmpMod</h1>
	<p class="max-w-xl text-lg opacity-80">
		Create projects while you're offline. Available for Windows, macOS, and Linux.
	</p>
...
<div id="downloads" class="m-auto my-16 grid max-w-6xl grid-cols-1 gap-8 px-6 md:grid-cols-3">
	...
	<div class="flex flex-col border border-accent/20 p-6">
		<div class="mb-6 flex items-center gap-3">
			...
			<h2 class="text-xl font-bold">GNU/Linux</h2>
		</div>
		<div class="flex flex-col gap-3">
			...
			<a href="https://aur.archlinux.org/packages/ampmod-bin" class={linkStyles}>
				...
				<span>Arch User Repository</span>
			</a>
		</div>
	</div>
</div>
...
>
	<div class="flex-1">
		...
		<ul class="space-y-2 text-sm opacity-70">
			<li>Windows 10 / macOS 12 Monterey or newer</li>
			<li>Modern Linux Distro (Glibc 2.27+)</li>
			<li>1GB RAM & 200MB Disk Space</li>
		</ul>
	</div>
	...
	<div class="flex-1">
		...
		<p class="mb-4 text-sm opacity-70">
			...
			not update automatically and internet is required to use the Music extension.
		</p>
		<a href="/downloads/AmpMod-Standalone.html" download class="link"> Download HTML file</a>
	</div>
</div>
